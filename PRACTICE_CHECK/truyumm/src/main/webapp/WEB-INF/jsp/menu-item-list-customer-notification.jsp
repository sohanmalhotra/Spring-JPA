...
<% List<Cart> l=(List<Cart>)request.getAttribute("cartlist");%>
			...
			<table>
				...
				<tr>
					...
					<td><%=m.getCategory()%></td>
					<td><a class="action-link" href="./menu-item-list-customer-notification?id=<%=m.getId()%>">Add to Cart</a></td>
				</tr>
				<%} %>
			<!--  	<tr>
					...
					<td>Main Course</td>
					<td><a class="action-link" href="./menu-item-list-customer-notification.html">Add to Cart</a></td>
				</tr>
				<tr>
